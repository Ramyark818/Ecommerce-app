    ...
    <div className='flex justify-between items-center py-4 font-medium'>
      <Link to={'/'}>
        ...
        <ul className='hidden sm:flex gap-5 text-sm text-gray-700'>
          ...
          <NavLink to='/collection' className='flex flex-col items-center gap-5'>
            <p>COLLECTION</p>
            <hr className='w-2/4 border-none h-[1.5px] bg-gray-700 hidden'></hr>
          </NavLink>

          <NavLink to='/about' className='flex flex-col items-center gap-5'>
            <p>ABOUT</p>
            <hr className='w-2/4 border-none h-[1.5px] bg-gray-700 hidden'></hr>
          </NavLink>

          <NavLink to='/contact' className='flex flex-col items-center gap-5'>
            <p>CONTACT</p>
            <hr className='w-2/4 border-none h-[1.5px] bg-gray-700 hidden'></hr>
          </NavLink>
        </ul>
